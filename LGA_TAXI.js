...
console.log('Starting Aviation Gadget #525');
...
page1.open("https://at123.azurewebsites.net/Info/AviatDebug.json", function(status) {
	setTimeout(function() {
		...
		LGATAXI.push("LGA Taxi Wait Time");
		LGATAXI.push(jsonAviation.LGA.taxi.html);
		LGATAXI.push(jsonAviation.LastUpdated);
		LGATAXI.push(0);

		var Mdata = Form([LGATAXI]);
