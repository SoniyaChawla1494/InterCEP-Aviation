...
console.log('Starting JFK Security Wait Line Gadget');
...
page1.open("https://at123.azurewebsites.net/Info/AviatDebug.json", function(status){
	setTimeout(function() {
		...
		JFKTSA.push("JFK TSA Wait Time");
		JFKTSA.push(jsonAviation.JFK.tsa.html);
		JFKTSA.push(jsonAviation.LastUpdated);
		JFKTSA.push(0);

		var Mdata = Form([JFKTSA]);
