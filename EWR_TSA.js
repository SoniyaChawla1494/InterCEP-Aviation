...
console.log('Starting EWR Security Wait Line Gadget');
...
page1.open("https://at123.azurewebsites.net/Info/AviatDebug.json", function(status){
	setTimeout(function() {
		...
		EWRTSA.push("EWR TSA Wait Time");
		EWRTSA.push(jsonAviation.EWR.tsa.html);
		EWRTSA.push(jsonAviation.LastUpdated);
		EWRTSA.push(0);

		var Mdata = Form([EWRTSA]);
