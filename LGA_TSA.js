...
console.log('Starting LGA Security Wait Line Gadget');
...
page1.open("https://at123.azurewebsites.net/Info/AviatDebug.json", function(status){
	setTimeout(function() {
		...
		LGATSA.push("LGA TSA Wait Time");
		LGATSA.push(jsonAviation.LGA.tsa.html);
		LGATSA.push(jsonAviation.LastUpdated);
		LGATSA.push(0);

		var Mdata = Form([LGATSA]);
