...
console.log('Starting Aviation Gadget #524');
...
page1.open("https://at123.azurewebsites.net/Info/AviatDebug.json", function(status){
	setTimeout(function() {
		...
		JFKTAXI.push("JFK Taxi Wait Time");
		JFKTAXI.push(jsonAviation.JFK.taxi.html);
		JFKTAXI.push(jsonAviation.LastUpdated);
		JFKTAXI.push(0);

		var Mdata = Form([JFKTAXI]);
