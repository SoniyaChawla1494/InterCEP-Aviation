...
console.log('Starting Aviation Gadget #523');
...
page1.open("https://at123.azurewebsites.net/Info/AviatDebug.json", function(status) {
	setTimeout(function() {
		...
		EWRPARKING.push("EWR Parking Wait Time");
		EWRPARKING.push(jsonAviation.EWR.parking.html);
		EWRPARKING.push(jsonAviation.LastUpdated);
		EWRPARKING.push(0);

		var Mdata = Form([EWRPARKING]);
