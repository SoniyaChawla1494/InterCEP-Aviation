...
console.log('Starting Aviation Gadget #518');
...
page1.open("https://at123.azurewebsites.net/Info/AviatDebug.json", function(status) {
	setTimeout(function() {
		...
		JFKAIR.push("Air - Kennedy Airport (JFK)");
		JFKAIR.push(jsonAviation.JFK.air.html);
		JFKAIR.push(jsonAviation.LastUpdated);
		JFKAIR.push(jsonAviation.JFK.air.statusColor);

		var Mdata = Form([JFKAIR]);
