...
console.log('Starting Aviation Gadget #521');
...
page1.open("https://at123.azurewebsites.net/Info/AviatDebug.json", function(status) {
	setTimeout(function() {
		...
		JFKPARKING.push("JFK Parking Wait Time");
		JFKPARKING.push(jsonAviation.JFK.parking.html);
		JFKPARKING.push(jsonAviation.LastUpdated);
		JFKPARKING.push(0);

		var Mdata = Form([JFKPARKING]);
