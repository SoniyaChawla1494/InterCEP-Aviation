...
console.log('Starting Aviation Gadget #526');
...
page1.open("https://at123.azurewebsites.net/Info/AviatDebug.json", function(status) {
	setTimeout(function() {
		...
		EWRTAXI.push("EWR Taxi Wait Time");
		EWRTAXI.push(jsonAviation.EWR.taxi.html);
		EWRTAXI.push(jsonAviation.LastUpdated);
		EWRTAXI.push(0);

		var Mdata = Form([EWRTAXI]);
