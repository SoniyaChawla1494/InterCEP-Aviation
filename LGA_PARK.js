...
console.log('Starting Aviation Gadget #522');
...
page1.open("https://at123.azurewebsites.net/Info/AviatDebug.json", function(status) {
	setTimeout(function() {
		...
		LGAPARKING.push("LGA Parking Wait Time");
		LGAPARKING.push(jsonAviation.LGA.parking.html);
		LGAPARKING.push(jsonAviation.LastUpdated);
		LGAPARKING.push(0);

		var Mdata = Form([LGAPARKING]);
