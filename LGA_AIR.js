...
console.log('Starting Aviation Gadget #519');
...
var page1 = require('webpage').create();
page1.open("https://at123.azurewebsites.net/Info/AviatDebug.json", function(status) {
	setTimeout(function() {
		...
		LGAAIR.push("Air - LaGuardia Airport (LGA)");
		LGAAIR.push(jsonAviation.LGA.air.html);
		LGAAIR.push(jsonAviation.LastUpdated);
		LGAAIR.push(jsonAviation.LGA.air.statusColor);

		var Mdata = Form([LGAAIR]);
